...
export const watchlist = [
  // ── Researched ────────────────────────────────────────────────────────────
  { symbol: 'PG',    name: 'Procter & Gamble',       sector: 'Consumer Staples',        price: 158.90, change: 0, changePercent: 0, fairValue: 175.00, buyBelow: 140.00, rating: 'Watch', upside: 10.1, safetyScore: 86, sparkline: [] as number[] },
  { symbol: 'HD',    name: 'Home Depot',              sector: 'Consumer Discretionary',  price: 342.10, change: 0, changePercent: 0, fairValue: 360.00, buyBelow: 288.00, rating: 'Watch', upside:  5.2, safetyScore: 76, sparkline: [] as number[] },
  // ── Technology ───────────────────────────────────────────────────────────
  { ..._w, symbol: 'AAPL',  name: 'Apple',                  sector: 'Technology'                },
  { ..._w, symbol: 'MSFT',  name: 'Microsoft',              sector: 'Technology'                },
  { ..._w, symbol: 'NVDA',  name: 'NVIDIA',                 sector: 'Technology'                },
  { ..._w, symbol: 'AVGO',  name: 'Broadcom',               sector: 'Technology'                },
  { ..._w, symbol: 'AMD',   name: 'Advanced Micro Devices', sector: 'Technology'                },
  { ..._w, symbol: 'TSM',   name: 'Taiwan Semiconductor',   sector: 'Technology'                },
  { ..._w, symbol: 'ASML',  name: 'ASML Holding',           sector: 'Technology'                },
  { ..._w, symbol: 'AMAT',  name: 'Applied Materials',      sector: 'Technology'                },
  { ..._w, symbol: 'MU',    name: 'Micron Technology',      sector: 'Technology'                },
  // ── Consumer ─────────────────────────────────────────────────────────────
  { ..._w, symbol: 'AMZN',  name: 'Amazon',                 sector: 'Consumer Discretionary'    },
  { ..._w, symbol: 'MCD',   name: "McDonald's",             sector: 'Consumer Discretionary'    },
  { ..._w, symbol: 'NKE',   name: 'Nike',                   sector: 'Consumer Discretionary'    },
  { ..._w, symbol: 'LOW',   name: "Lowe's",                 sector: 'Consumer Discretionary'    },
  { ..._w, symbol: 'BABA',  name: 'Alibaba',                sector: 'Consumer Discretionary'    },
  { ..._w, symbol: 'COST',  name: 'Costco',                 sector: 'Consumer Staples'          },
  { ..._w, symbol: 'PEP',   name: 'PepsiCo',                sector: 'Consumer Staples'          },
  { ..._w, symbol: 'WMT',   name: 'Walmart',                sector: 'Consumer Staples'          },
  { ..._w, symbol: 'KO',    name: 'Coca-Cola',              sector: 'Consumer Staples'          },
  // ── Financials ───────────────────────────────────────────────────────────
  { ..._w, symbol: 'MA',    name: 'Mastercard',             sector: 'Financials'                },
  { ..._w, symbol: 'V',     name: 'Visa',                   sector: 'Financials'                },
  { ..._w, symbol: 'JPM',   name: 'JPMorgan Chase',         sector: 'Financials'                },
  { ..._w, symbol: 'BRK.B', name: 'Berkshire Hathaway',     sector: 'Financials'                },
  { ..._w, symbol: 'BAC',   name: 'Bank of America',        sector: 'Financials'                },
  { ..._w, symbol: 'WFC',   name: 'Wells Fargo',            sector: 'Financials'                },
  // ── Healthcare ───────────────────────────────────────────────────────────
  { ..._w, symbol: 'JNJ',   name: 'Johnson & Johnson',      sector: 'Healthcare'                },
  // ── Real Estate ──────────────────────────────────────────────────────────
  { ..._w, symbol: 'O',     name: 'Realty Income',          sector: 'Real Estate'               },
  { ..._w, symbol: 'VICI',  name: 'VICI Properties',        sector: 'Real Estate'               },
  { ..._w, symbol: 'PLD',   name: 'Prologis',               sector: 'Real Estate'               },
  { ..._w, symbol: 'AMT',   name: 'American Tower',         sector: 'Real Estate'               },
  // ── Communication Services ────────────────────────────────────────────────
  { ..._w, symbol: 'DIS',   name: 'Walt Disney',            sector: 'Communication Services'    },
  { ..._w, symbol: 'VZ',    name: 'Verizon',                sector: 'Communication Services'    },
]
